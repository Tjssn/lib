...
`Super.Table`
主要用于生成医学论文、临床研究、心理学、公卫、护理、检验等场景中的 Table
1。
...
You can install the development version of `TjSuper` from GitHub with:

``` r
# install.packages("remotes")
remotes::install_github("Tjssn/lib", subdir = "TjSuper")
```
